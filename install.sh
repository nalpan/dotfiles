...
mkdir -p $DIR/backup/.config/git && [[ ! -f $DIR/backup/.config/git/ignore ]] && mv ~/.config/git/ignore $DIR/backup/.config/git/ignore
mkdir -p $DIR/backup/.copilot && [[ ! -f $DIR/backup/.copilot/copilot-instructions.md ]] && mv ~/.copilot/copilot-instructions.md $DIR/backup/.copilot/copilot-instructions.md
...
mkdir -p ~/.config/git && [[ ! -f ~/.config/git/ignore ]] && ln -s $DIR/
 ~/.config/git/ignore
